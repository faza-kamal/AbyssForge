...
async def scan(
    ...
    for page in crawled:
        ...
        # Periksa konten halaman menggunakan body yang sudah di-crawl
        if page.body:
            findings.extend(_check_sensitive_content(page.body, page.url))
            findings.extend(_check_error_leaks(page.body, page.url))
            findings.extend(_fingerprint_technology(page.body, page.headers, page.url))
